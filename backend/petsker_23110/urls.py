"""petsker_23110 URL Configuration
...
admin.site.site_header = "Petsker"
admin.site.site_title = "Petsker Admin Portal"
admin.site.index_title = "Petsker Admin"

# swagger
api_info = openapi.Info(
    title="Petsker API",
    default_version="v1",
    description="API documentation for Petsker App",
)
